...
public class Friends extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<String> items = Arrays.asList(loginDataBaseAdapter.getFriends(destination_string).split("\\s*,\\s*"));       
	     ...
	     btnAdd.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				else
				{
				    ...
				    loginDataBaseAdapter.updateFriends(destination_string,Search);
				}

				/// Create Intent for SignUpActivity  and Start The Activity
				Intent intentLocation=new Intent(getApplicationContext(),Friends.class);
